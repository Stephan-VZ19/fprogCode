...
/* package WS-Webclient-0.1.0.0 */
#ifndef VERSION_WS_Webclient
#define VERSION_WS_Webclient "0.1.0.0"
#endif /* VERSION_WS_Webclient */
#ifndef MIN_VERSION_WS_Webclient
#define MIN_VERSION_WS_Webclient(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_WS_Webclient */
...
#define CURRENT_COMPONENT_ID "WS-Webclient-0.1.0.0-inplace-webclient"
